...
/**
 * Board: Leonardo
 * Info: https://store-usa.arduino.cc/products/arduino-leonardo-with-headers
 */
...
static const uint8_t CH_PINS[CHP_NUM] = {10, 11};
// MIDI Channel to use (0 = ch 1, 1 = ch 2, ..., 15 = ch 16):
static byte MIDI_CH = 0;

// CC Bank encoder pins:
static const uint8_t CB_PINS[CBP_NUM] = {12, 13};
// CC Bank to use:
